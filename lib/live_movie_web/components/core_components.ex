defmodule LiveMovieWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveMovieWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveMovieWeb.Gettext, "errors", msg, opts)
    end
  end
